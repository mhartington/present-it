...
s=document.querySelector("script[data-namespace='present-it']");if(s){resourcesUrl=s.getAttribute('data-resources-url');}
      ...
      if ('style' === memberName) {
        ...
        if ('list' !== memberName && 'type' !== memberName && !isSvg && (memberName in elm || -1 !== [ 'object', 'function' ].indexOf(typeof newValue) && null !== newValue) || false) {
          ...
          if (cmpMeta && cmpMeta.membersMeta && cmpMeta.membersMeta[memberName]) {
            ...
            (true, isHostElement) && cmpMeta.membersMeta[memberName].reflectToAttr && 
